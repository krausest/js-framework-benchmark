import { h, render, state } from '@zouloux/reflex';
import { IStateObservable } from "@zouloux/reflex/dist/observable";
...
function Row ({ selected, item, dispatch, key, pure }) {
...
// const Row = memo(() => (), (prevProps, nextProps) => prevProps.selected === nextProps.selected && prevProps.item === nextProps.item)
