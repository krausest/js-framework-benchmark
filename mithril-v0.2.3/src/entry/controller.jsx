            ...
            <div class="jumbotron">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <button type="button" class="btn btn-primary btn-block" id="hideall" onclick={ctrl.hideAll}>HideAll</button>
                        <button type="button" class="btn btn-primary btn-block" id="showall" onclick={ctrl.showAll}>ShowAll</button>
                        <button type="button" class="btn btn-primary btn-block" id="runlots" onclick={ctrl.runLots}>Create lots of rows</button>
