...
export abstract class CPUBenchmarkPuppeteer
  implements benchmarksCommon.BenchmarkImpl
{
...
export abstract class MemBenchmarkPuppeteer
  implements benchmarksCommon.BenchmarkImpl
{
...
export const benchSelect = new (class extends CPUBenchmarkPuppeteer {
  ...
  async init(page: Page) {
    ...
    for (let i = 0; i <= config.WARMUP_COUNT; i++) {
      ...
      await checkElementHasClass(
        page,
        `pierce/tbody>tr:nth-of-type(${i + 5})`,
        "danger",
      );
  ...
  async run(page: Page) {
    await clickElement(
      page,
      "pierce/tbody>tr:nth-of-type(2)>td:nth-of-type(2)>a",
    );
    await checkElementHasClass(
      page,
      "pierce/tbody>tr:nth-of-type(2)",
      "danger",
    );
  }
})();
...
export const benchSwapRows = new (class extends CPUBenchmarkPuppeteer {
  ...
  async run(page: Page) {
    ...
    await checkElementContainsText(
      page,
      "pierce/tbody>tr:nth-of-type(2)>td:nth-of-type(1)",
      "999",
    );
  }
})();
...
export const benchRemove = new (class extends CPUBenchmarkPuppeteer {
  ...
  async init(page: Page) {
    ...
    await checkElementContainsText(
      page,
      `pierce/tbody>tr:nth-of-type(5)>td:nth-of-type(1)`,
      "10",
    );
    await checkElementContainsText(
      page,
      `pierce/tbody>tr:nth-of-type(4)>td:nth-of-type(1)`,
      "4",
    );
    ...
    await checkElementContainsText(
      page,
      `pierce/tbody>tr:nth-of-type(6)>td:nth-of-type(1)`,
      "11",
    );
    await clickElement(
      page,
...
export const benchRunBig = new (class extends CPUBenchmarkPuppeteer {
  ...
  async run(page: Page) {
    ...
    await checkElementExists(
      page,
      "pierce/tbody>tr:nth-of-type(10000)>td:nth-of-type(2)>a",
    );
  }
})();
...
export const benchAppendToManyRows = new (class extends CPUBenchmarkPuppeteer {
  ...
  async run(page: Page) {
    ...
    await checkElementExists(
      page,
      "pierce/tbody>tr:nth-of-type(2000)>td:nth-of-type(1)",
    );
  }
})();
...
export const benchUpdate5Memory = new (class extends MemBenchmarkPuppeteer {
  ...
  async run(page: Page) {
    ...
    await checkElementExists(
      page,
      "pierce/tbody>tr:nth-of-type(1000)>td:nth-of-type(2)>a",
    );
    for (let i = 0; i < 5; i++) {
      await clickElement(page, "pierce/#update");
      await checkElementContainsText(
...
export const benchCreateClear5Memory =
  new (class extends MemBenchmarkPuppeteer {
    constructor() {
