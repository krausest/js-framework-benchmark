...
const resultsDirectory = args.browser
  ? "./results_client_" + args.browser
  : "./results";
...
async function main() {
        ...
        if (fs.existsSync(file)) {
          ...
          for (const key of Object.keys(data.values)) {
            ...
            if (
              ...
              vals.length != config.NUM_ITERATIONS_FOR_BENCHMARK_CPU
            ) {
              console.log(
  ...
  resultJS +=
    "export const benchmarks = " + JSON.stringify(formattedBenchmarks) + ";\n";
