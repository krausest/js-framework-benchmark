...
function f(
  name: string,
  keyed: boolean,
  options: Options = { uri: null, useShadowRoot: false }
): FrameworkData {
  let ret = {
    name,
    keyed,
...
export let frameworks = [
  ...
  f("binding.scala-v10.0.1-keyed", true, {
    uri: "binding.scala-v10.0.1-keyed/target/web/stage"
  }),
  ...
  // f("halogen-v2.1.0-non-keyed", false),    // https://github.com/krausest/js-framework-benchmark/issues/294
  ...
  f("polymer-v2.0.0-non-keyed", false, {
    uri: "polymer-v2.0.0-non-keyed/build/es6-bundled",
    useShadowRoot: true
  }),
