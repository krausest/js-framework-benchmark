import { app, createState, Vode, A, BUTTON, DIV, H1, SPAN, TABLE, TBODY, TR, TD, keyed, memo } from "@ryupold/vode";
...
app(
    ...
    state, 
    (s: State) => <Vode<State>>[DIV, 
    { class: "container", id: 'main' },

    // Control Buttons
    memo([], () => [DIV, { class: "jumbotron" },
        [DIV, { class: "row" },
            [DIV, { class: "col-md-6" },
                [H1, `[V,{},d,e] ${packageJson.dependencies["@ryupold/vode"]} (keyed)`],
            ],
            [DIV, { class: "col-md-6" },
                [DIV, { class: "row" },
