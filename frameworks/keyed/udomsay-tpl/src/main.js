// Fully readpted from Solid-js benchmark
...
const Table = () => esx`
  <table class='table table-hover table-striped test-data'>
    <tbody>${data.value.map(({id: rowId, label}, idx) => esx`
      <tr key=${rowId}>
...
const App = () => esx`
  <div class='container'>
    <div class='jumbotron'><div class='row'>
      <div class='col-md-6'><h1>udomsay-tpl ☣ Keyed</h1></div>
...
import {ESX} from '@ungap/esx';
const esx = ESX({Button, Table});
