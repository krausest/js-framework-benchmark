...
function createRowView(id, label, selected) {
  return html`<tr class="${selected ? 'danger' : false}"><td class="col-md-1">${id}</td><td class="col-md-4"><a @click="${selectRow}">${label}</a></td><td class="col-md-1"><a @click="${removeRow}"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td><td class="col-md-6"></td></tr>`;
}
