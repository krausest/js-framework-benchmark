...
(function( root, factory ) {
    if( typeof define === "function" && define.amd ) {
        ...
        Rust.js_framework_benchmark_stdweb = factory();
    }
}( this, function() {
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "js-framework-benchmark-stdweb.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            return fetch( "js-framework-benchmark-stdweb.wasm", {credentials: "same-origin"} )
                .then( function( response ) { return response.arrayBuffer(); } )
                .then( function( bytes ) { return WebAssembly.compile( bytes ); } )
                .then( function( mod ) { return WebAssembly.instantiate( mod, instance.imports ) } )
                .then( function( wasm_instance ) {
                    var exports = instance.initialize( wasm_instance );
                    console.log( "Finished loading Rust wasm module 'js_framework_benchmark_stdweb'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'js_framework_benchmark_stdweb':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__extjs_39bf06b6d380ae3b71a1587f9c5c5260510aa519": function($0, $1) {
            ...
            "__extjs_ed3be42d4d500cf86116112487347aa9284f8b11": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);($0). remove ();
            },
            "__extjs_d5c4a83163d59af0ad9c7993135710ed06a97b85": function($0, $1, $2) {
            ...
            "__extjs_7b12934795216b2bdcc85809e3f1cd473c3a0661": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). contains (($2));})());
            },
