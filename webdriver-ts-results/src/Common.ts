...
export class ResultTableData {
  ...
  computeGeometricMean(
    ...
    if (type == BenchmarkType.CPU) {
      benchmarkWeights = [0.64280248137063,0.5607178150466176,0.5643800750716564,0.1925635870170522,0.13200612879341714,0.5277091212292658,0.5644449600965534,0.5508359820582848,0.4225836631419211,0.5607178150466176];
    } else {
