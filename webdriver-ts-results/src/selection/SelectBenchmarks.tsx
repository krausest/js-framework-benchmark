...
const SelectBenchmarkCategory = ({
  ...
  const benchmarks = useSelector<State, Benchmark[]>(
    (state) => state.benchmarkLists[benchmarkType],
  );
  const selectedBenchmarks = useSelector<State, Set<Benchmark>>(
    (state) => state.selectedBenchmarks,
  );
  const isNoneSelected = useSelector<State, boolean>((state) =>
    isNoneBenchmarkSelected(state, benchmarkType),
  );
  const areAllSelected = useSelector<State, boolean>((state) =>
  ...
  return (
    ...
    >
      ...
      <div>
        <SelectBarBenchmarks
          isSelected={(b) => selectedBenchmarks.has(b)}
